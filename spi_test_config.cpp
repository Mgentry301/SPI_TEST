...
void apply_spi_preset(uint8_t preset) {
  ...
  static const uint16_t admv1455_poll[] = {0x000, 0x00A, 0x005, 0x012, 0x040, 0x050};
  static const uint16_t admv1355_poll[] = {0x000, 0x00A, 0x001, 0x003, 0x004, 0x005};
  static const uint16_t ad9082_poll[] = {0x0000, 0x0001, 0x0002, 0x0003};
  ...
  if (preset == SPI_TEST_PRESET_ADMV1355_MINIMAL) {
    ...
    g_poll_regs = admv1355_poll;
    g_poll_regs_count = sizeof(admv1355_poll) / sizeof(admv1355_poll[0]);
    ...
    g_poll_regs = ad9082_poll;
    g_poll_regs_count = sizeof(ad9082_poll) / sizeof(ad9082_poll[0]);
